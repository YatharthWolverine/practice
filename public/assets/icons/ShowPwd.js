...
function ShowPwd(props) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 22 22" fill="none" {...props}>
      ...
      />
      <path
        d="M11 6.648A4.357 4.357 0 006.648 11c0 2.4 1.952 4.352 4.352 4.352 2.4 0 4.352-1.952 4.352-4.352 0-2.4-1.953-4.352-4.352-4.352zm0 7.253a2.904 2.904 0 01-2.901-2.9c0-1.6 1.301-2.902 2.9-2.902 1.6 0 2.902 1.301 2.902 2.901 0 1.6-1.301 2.901-2.901 2.901z"
        fill="#000"
      />
    </svg>
  );
...
const MemoShowPwd = React.memo(ShowPwd);
export default MemoShowPwd;
